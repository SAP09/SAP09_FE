    ...
    return Controller.extend("odata.metadata.manager.controller.Dashboard", {
      ...
      _updateDetailBadges: function (oService) {
        ...
        if (oPrefixBadge) {
          ...
          if (typeEl) {
            ...
            typeEl.className =
              "badge badge-" + oService.type.toLowerCase() + " detailTypeBadge";
          }
      ...
      _applyFilters: function () {
        ...
        var aFiltered = aAll.filter(function (svc) {
          ...
          if (sSearch && svc.name.toLowerCase().indexOf(sSearch) < 0)
            return false;
        ...
        aAll.forEach(
          function (svc) {
            ...
            if (oItem) {
              var bVisible = aFiltered.some(function (f) {
                return f.id === svc.id;
              });
