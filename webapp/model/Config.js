sap.ui.define([], function () {
  ...
  return {
    ...
    // Direct OData backend access without Approuter.
    BACKEND_ENABLED: true,

    // Same-origin path when this app is deployed to the SAP ABAP server.
    // Keep this relative path so UI and OData run on the same origin in BSP.
